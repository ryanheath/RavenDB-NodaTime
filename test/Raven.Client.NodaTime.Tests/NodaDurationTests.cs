...
{
    [Fact]
    public void Can_Use_NodaTime_Duration_In_Document_Positive() => Can_Use_NodaTime_Duration_In_Document(Duration.FromHours(2));

    [Fact]
    public void Can_Use_NodaTime_Duration_In_Document_Negative() => Can_Use_NodaTime_Duration_In_Document(Duration.FromHours(-5));

    [Fact]
    public void Can_Use_NodaTime_Duration_In_Document_Min() => Can_Use_NodaTime_Duration_In_Document(NodaUtil.Duration.MinValue);

    [Fact]
    public void Can_Use_NodaTime_Duration_In_Document_Max() => Can_Use_NodaTime_Duration_In_Document(NodaUtil.Duration.MaxValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_Duration_In_Dynamic_Index_Positive() => Can_Use_NodaTime_Duration_In_Dynamic_Index1(Duration.FromHours(2));

    [Fact]
    public void Can_Use_NodaTime_Duration_In_Dynamic_Index_Negative() => Can_Use_NodaTime_Duration_In_Dynamic_Index2(Duration.FromHours(-5));

    [Fact]
    public void Can_Use_NodaTime_Duration_In_Dynamic_Index_Min() => Can_Use_NodaTime_Duration_In_Dynamic_Index1(NodaUtil.Duration.MinValue);

    [Fact]
    public void Can_Use_NodaTime_Duration_In_Dynamic_Index_Max() => Can_Use_NodaTime_Duration_In_Dynamic_Index2(NodaUtil.Duration.MaxValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_Duration_In_Static_Index_Positive() => Can_Use_NodaTime_Duration_In_Static_Index1(Duration.FromHours(2));

    [Fact]
    public void Can_Use_NodaTime_Duration_In_Static_Index_Negative() => Can_Use_NodaTime_Duration_In_Static_Index2(Duration.FromHours(-5));

    [Fact]
    public void Can_Use_NodaTime_Duration_In_Static_Index_Min() => Can_Use_NodaTime_Duration_In_Static_Index1(NodaUtil.Duration.MinValue);

    [Fact]
    public void Can_Use_NodaTime_Duration_In_Static_Index_Max() => Can_Use_NodaTime_Duration_In_Static_Index2(NodaUtil.Duration.MaxValue);
