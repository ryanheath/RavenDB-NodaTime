...
{
    [Fact]
    public void Can_Use_NodaTime_OffsetDateTime_In_Document_Now() => Can_Use_NodaTime_OffsetDateTime_In_Document(NodaUtil.OffsetDateTime.Now);

    [Fact]
    public void Can_Use_NodaTime_OffsetDateTime_In_Document_IsoMin() => Can_Use_NodaTime_OffsetDateTime_In_Document(NodaUtil.OffsetDateTime.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_OffsetDateTime_In_Document_IsoMax() => Can_Use_NodaTime_OffsetDateTime_In_Document(NodaUtil.OffsetDateTime.MaxIsoValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_OffsetDateTime_In_Dynamic_Index_Now() => Can_Use_NodaTime_OffsetDateTime_In_Dynamic_Index1(NodaUtil.OffsetDateTime.Now);

    [Fact]
    public void Can_Use_NodaTime_OffsetDateTime_In_Dynamic_Index_IsoMin() => Can_Use_NodaTime_OffsetDateTime_In_Dynamic_Index1(NodaUtil.OffsetDateTime.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_OffsetDateTime_In_Dynamic_Index_IsoMax() => Can_Use_NodaTime_OffsetDateTime_In_Dynamic_Index2(NodaUtil.OffsetDateTime.MaxIsoValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_OffsetDateTime_In_Static_Index_Now() => Can_Use_NodaTime_OffsetDateTime_In_Static_Index1(NodaUtil.OffsetDateTime.Now);

    [Fact]
    public void Can_Use_NodaTime_OffsetDateTime_In_Static_Index_IsoMin() => Can_Use_NodaTime_OffsetDateTime_In_Static_Index1(NodaUtil.OffsetDateTime.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_OffsetDateTime_In_Static_Index_IsoMax() => Can_Use_NodaTime_OffsetDateTime_In_Static_Index2(NodaUtil.OffsetDateTime.MaxIsoValue);
