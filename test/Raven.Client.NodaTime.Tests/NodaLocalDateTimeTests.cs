...
{
    [Fact]
    public void Can_Use_NodaTime_LocalDateTime_In_Document_Now() => Can_Use_NodaTime_LocalDateTime_In_Document(NodaUtil.LocalDateTime.Now);

    [Fact]
    public void Can_Use_NodaTime_LocalDateTime_In_Document_IsoMin() => Can_Use_NodaTime_LocalDateTime_In_Document(NodaUtil.LocalDateTime.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_LocalDateTime_In_Document_IsoMax() => Can_Use_NodaTime_LocalDateTime_In_Document(NodaUtil.LocalDateTime.MaxIsoValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_LocalDateTime_In_Dynamic_Index_Now() => Can_Use_NodaTime_LocalDateTime_In_Dynamic_Index1(NodaUtil.LocalDateTime.Now);

    [Fact]
    public void Can_Use_NodaTime_LocalDateTime_In_Dynamic_Index_IsoMin() => Can_Use_NodaTime_LocalDateTime_In_Dynamic_Index1(NodaUtil.LocalDateTime.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_LocalDateTime_In_Dynamic_Index_IsoMax() => Can_Use_NodaTime_LocalDateTime_In_Dynamic_Index2(NodaUtil.LocalDateTime.MaxIsoValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_LocalDateTime_In_Static_Index_Now() => Can_Use_NodaTime_LocalDateTime_In_Static_Index1(NodaUtil.LocalDateTime.Now);

    [Fact]
    public void Can_Use_NodaTime_LocalDateTime_In_Static_Index_IsoMin() => Can_Use_NodaTime_LocalDateTime_In_Static_Index1(NodaUtil.LocalDateTime.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_LocalDateTime_In_Static_Index_IsoMax() => Can_Use_NodaTime_LocalDateTime_In_Static_Index2(NodaUtil.LocalDateTime.MaxIsoValue);
