...
{
    [Fact]
    public void Can_Use_NodaTime_Offset_In_Document_Positive() => Can_Use_NodaTime_Offset_In_Document(Offset.FromHours(2));

    [Fact]
    public void Can_Use_NodaTime_Offset_In_Document_Negative() => Can_Use_NodaTime_Offset_In_Document(Offset.FromHoursAndMinutes(-5, 30));

    [Fact]
    public void Can_Use_NodaTime_Offset_In_Document_Min() => Can_Use_NodaTime_Offset_In_Document(Offset.MinValue);

    [Fact]
    public void Can_Use_NodaTime_Offset_In_Document_Max() => Can_Use_NodaTime_Offset_In_Document(Offset.MaxValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_Offset_In_Dynamic_Index_Positive() => Can_Use_NodaTime_Offset_In_Dynamic_Index1(Offset.FromHours(2));

    [Fact]
    public void Can_Use_NodaTime_Offset_In_Dynamic_Index_Negative() => Can_Use_NodaTime_Offset_In_Dynamic_Index2(Offset.FromHoursAndMinutes(-5, 30));

    [Fact]
    public void Can_Use_NodaTime_Offset_In_Dynamic_Index_Min() => Can_Use_NodaTime_Offset_In_Dynamic_Index1(Offset.MinValue);

    [Fact]
    public void Can_Use_NodaTime_Offset_In_Dynamic_Index_Max() => Can_Use_NodaTime_Offset_In_Dynamic_Index2(Offset.MaxValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_Offset_In_Static_Index_Positive() => Can_Use_NodaTime_Offset_In_Static_Index1(Offset.FromHours(2));

    [Fact]
    public void Can_Use_NodaTime_Offset_In_Static_Index_Negative() => Can_Use_NodaTime_Offset_In_Static_Index2(Offset.FromHoursAndMinutes(-5, 30));

    [Fact]
    public void Can_Use_NodaTime_Offset_In_Static_Index_Min() => Can_Use_NodaTime_Offset_In_Static_Index1(Offset.MinValue);

    [Fact]
    public void Can_Use_NodaTime_Offset_In_Static_Index_Max() => Can_Use_NodaTime_Offset_In_Static_Index2(Offset.MaxValue);
