...
{
    [Fact]
    public void Can_Use_NodaTime_LocalDate_In_Document_Today() => Can_Use_NodaTime_LocalDate_In_Document(NodaUtil.LocalDate.Today);

    [Fact]
    public void Can_Use_NodaTime_LocalDate_In_Document_IsoMin() => Can_Use_NodaTime_LocalDate_In_Document(NodaUtil.LocalDate.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_LocalDate_In_Document_IsoMax() => Can_Use_NodaTime_LocalDate_In_Document(NodaUtil.LocalDate.MaxIsoValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_LocalDate_In_Dynamic_Index_Today() => Can_Use_NodaTime_LocalDate_In_Dynamic_Index1(NodaUtil.LocalDate.Today);

    [Fact]
    public void Can_Use_NodaTime_LocalDate_In_Dynamic_Index_IsoMin() => Can_Use_NodaTime_LocalDate_In_Dynamic_Index1(NodaUtil.LocalDate.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_LocalDate_In_Dynamic_Index_IsoMax() => Can_Use_NodaTime_LocalDate_In_Dynamic_Index2(NodaUtil.LocalDate.MaxIsoValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_LocalDate_In_Static_Index_Today() => Can_Use_NodaTime_LocalDate_In_Static_Index1(NodaUtil.LocalDate.Today);

    [Fact]
    public void Can_Use_NodaTime_LocalDate_In_Static_Index_IsoMin() => Can_Use_NodaTime_LocalDate_In_Static_Index1(NodaUtil.LocalDate.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_LocalDate_In_Static_Index_IsoMax() => Can_Use_NodaTime_LocalDate_In_Static_Index2(NodaUtil.LocalDate.MaxIsoValue);
