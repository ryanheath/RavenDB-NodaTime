...
{
    [Fact]
    public void Can_Use_NodaTime_LocalTime_In_Document_Now() => Can_Use_NodaTime_LocalTime_In_Document(NodaUtil.LocalTime.Now);

    [Fact]
    public void Can_Use_NodaTime_LocalTime_In_Document_IsoMin() => Can_Use_NodaTime_LocalTime_In_Document(NodaUtil.LocalTime.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_LocalTime_In_Document_IsoMax() => Can_Use_NodaTime_LocalTime_In_Document(NodaUtil.LocalTime.MaxIsoValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_LocalTime_In_Dynamic_Index_Now() => Can_Use_NodaTime_LocalTime_In_Dynamic_Index1(NodaUtil.LocalTime.Now);

    [Fact]
    public void Can_Use_NodaTime_LocalTime_In_Dynamic_Index_IsoMin() => Can_Use_NodaTime_LocalTime_In_Dynamic_Index1(NodaUtil.LocalTime.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_LocalTime_In_Dynamic_Index_IsoMax() => Can_Use_NodaTime_LocalTime_In_Dynamic_Index2(NodaUtil.LocalTime.MaxIsoValue);
    ...
    [Fact]
    public void Can_Use_NodaTime_LocalTime_In_Static_Index_Now() => Can_Use_NodaTime_LocalTime_In_Static_Index1(NodaUtil.LocalTime.Now);

    [Fact]
    public void Can_Use_NodaTime_LocalTime_In_Static_Index_IsoMin() => Can_Use_NodaTime_LocalTime_In_Static_Index1(NodaUtil.LocalTime.MinIsoValue);

    [Fact]
    public void Can_Use_NodaTime_LocalTime_In_Static_Index_IsoMax() => Can_Use_NodaTime_LocalTime_In_Static_Index2(NodaUtil.LocalTime.MaxIsoValue);
