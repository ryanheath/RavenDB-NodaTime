...
internal static class NumberUtil
{
    ...
    /// </summary>
    public static string NumberToString(long number) => number.ToString("G", CultureInfo.InvariantCulture);

    /// <summary>
    /// Translate a number to an indexable string
    /// </summary>
    public static string NumberToString(double number) => number.ToString("G", CultureInfo.InvariantCulture);

    public static string NumberToString(float number) => number.ToString("G", CultureInfo.InvariantCulture);
}
